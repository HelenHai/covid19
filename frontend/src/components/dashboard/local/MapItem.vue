...
import pie from "../common/data/pie";
import polar from "../common/data/polar";
import scatter from "../common/data/scatter";
import map from "../common/data/map";
import { c1, c2 } from "../common/data/connect";
// custom theme
...
export default {
  ...
  methods: {
    ...
    loadFlights() {
      ...
      import("../common/data/flight.json").then(({ default: data }) => {
